...
describe Drink do
  describe '#initialize' do
    context 'when type is specified and ounces is default' do
      ...
      # beverage type.
      subject(:my_drink) { described_class.new('RedBull', 16) }
      # remove the 'x' before running this test
      it 'is your choice of beverage' do
        expect(my_drink.type).to eq('RedBull')
      end
  ...
  describe '#full?' do
    ...
    context 'when drink has less than 16 ounces' do
      ...
      subject(:my_drink) { described_class.new('RedBull', 8) }
      # remove the 'x' before running this test
      it 'is not full' do
      ...
      it 'is not empty' do
        expect(my_drink).to_not be_empty
      end
    end
  end
end
